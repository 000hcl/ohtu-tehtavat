...
class TestOstoskori(unittest.TestCase):
    ...
    def test_yhden_tuotteen_lisaaminen_jalkeen_korissa_yksi_tavara(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.assertEqual(self.kori.tavaroita_korissa(),1)
    
    def test_yhden_tuotteen_lisaaminen_jalkeen_korin_hinta_on_sama_kuin_tuotteen_hinta(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
    ...
    def test_kahden_eri_tuotteiden_lisaamisen_jalkeen_ostoskori_sisaltaa_kaksi_ostosta(self):
        juusto = Tuote("Juusto", 4)
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(juusto)
        self.kori.lisaa_tuote(maito)
    ...
    def test_test_kahden_saman_tuotteen_lisaamisen_jalkeen_ostoskori_sisaltaa_yhden_ostoksen(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
